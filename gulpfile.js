...
function serve(callback) {
    ...
    gulp.watch('./src/pathogenesis/**/*', gulp.series('copyUnityAssets1', 'copyUnityAssets2', 'copyUnityAssets3', 'copyUnityAssets4', reload))
    callback()
}
...
// Copy Pathogenesis 
gulp.task('copyUnityAssets1', function() {
    return gulp.src('./src/pathogenesis/StreamingAssets/**/*')
        .pipe(gulp.dest('./dist/pathogenesis/StreamingAssets'))
})
gulp.task('copyUnityAssets2', function() {
    return gulp.src('./src/pathogenesis/Build/**/*')
        .pipe(gulp.dest('./dist/pathogenesis/Build'))
})
gulp.task('copyUnityAssets3', function() {
    return gulp.src('./src/pathogenesis/TemplateData/**/*')
        .pipe(gulp.dest('./dist/pathogenesis/TemplateData'))
})
gulp.task('copyUnityAssets4', function() {
    return gulp.src(['./src/pathogenesis/manifest.webmanifest', './src/pathogenesis/ServiceWorker.js'])
        .pipe(gulp.dest('./dist/pathogenesis'))
})

// TASK LISTS
gulp.task('default', gulp.series('css', 'js', 'html', 'images', 'fonts', 'videos', 'copyUnityAssets1', 'copyUnityAssets2', 'copyUnityAssets3', 'copyUnityAssets4', 'copyShared'))
gulp.task('build', gulp.series('css', 'js', 'html', 'images', 'fonts', 'videos', 'copyUnityAssets1', 'copyUnityAssets2', 'copyUnityAssets3', 'copyUnityAssets4', 'copyShared'))
